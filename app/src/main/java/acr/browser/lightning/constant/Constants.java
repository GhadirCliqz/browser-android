...
public final class Constants {
	...
	public static final String JAVASCRIPT_LOAD_ANTIPHISHING = "javascript:(function(d){script = d.createElement('script'); script.type = 'text/javascript'; script.async = true; script.src = 'file:///android_asset/js/CliqzAntiPhishing.js'; d.getElementsByTagName('head')[0].appendChild(script)})(document);";
